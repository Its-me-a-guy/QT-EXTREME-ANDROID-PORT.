...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'bf', isPlayer:Bool = false)
	{
		...
		animation.add('bf-with-gf', [32, 33], 0, false, isPlayer);
		...
		animation.add('gf-no-present', [36], 0, false, isPlayer);
		animation.add('gf-demon', [31], 0, false, isPlayer);
		animation.add('compota', [34, 35], 0, false, isPlayer);
		animation.add('parents-christmas', [17, 18], 0, false, isPlayer);
		animation.add('monster', [19, 20], 0, false, isPlayer);
		animation.add('monster-christmas', [19, 20], 0, false, isPlayer);
		animation.add('robot', [24, 25], 0, false, isPlayer);
		animation.add('robot_angry', [30, 25], 0, false, isPlayer);
		...
		animation.add('qt_annoyed', [36, 27], 0, false, isPlayer);
