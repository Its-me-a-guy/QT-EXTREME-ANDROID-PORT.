...
class Character extends FlxSprite
{
	...
	//Contains every character for the game.
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-no-present':
				tex = Paths.getSparrowAtlas('NoGF_assets');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-demon':
				tex = Paths.getSparrowAtlas('DemonGF_assets');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'spooky':
				...
				playAnim('danceRight');
			case 'mom':
				tex = Paths.getSparrowAtlas('Mom_Assets','shared');
				frames = tex;
			...
			case 'bf-with-gf':
				var tex = Paths.getSparrowAtlas('BF-with-GF','shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				addOffset('idle', -5, 10);
				addOffset("singUP", -29, 27);
				addOffset("singRIGHT", -38, 30);
				addOffset("singLEFT", 12, 12);
				addOffset("singDOWN", -10, -3);
				addOffset("singUPmiss", -29, 27);
				addOffset("singRIGHTmiss", -30, 43);
				...
				flipX = true;
			case 'compota':
				var tex = Paths.getSparrowAtlas('Compota','shared');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				if (isPlayer)
				...
				if (isPlayer)
					...
					{
						addOffset('idle', -125,-347);
						addOffset("singUP", -138, -315);
						addOffset("singRIGHT", -160, -353);
						addOffset("singLEFT", -89, -353);
						addOffset("singDOWN", -150, -394);
					}	
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		if (isPlayer)
		{
			...
			if (!curCharacter.startsWith('bf') && !curCharacter.startsWith('compota'))
			{
				// var animArray
